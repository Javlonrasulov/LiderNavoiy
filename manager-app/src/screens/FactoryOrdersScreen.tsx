...
import { ArrowLeft, BarChart3, Check, Package, Plus, Trash2, X } from '../icons'
import {
  fetchGoodsReceipt,
  fetchGoodsReceipts,
  fetchMissingStats,
      ...
      <div style={{
        ...
        {pickerOpen && (
          <div style={{
            ...
            <div style={{
              width: '100%', maxHeight: '80%', background: c.card, borderRadius: '20px 20px 0 0',
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', gap: 8, background: c.muted, borderRadius: 14, padding: 4 }}>
          {([
            ...
            return (
              <button key={id} type="button" onClick={() => setTab(id)}
                style={{
                  ...
                  color: active ? c.primary : c.mutedText, fontWeight: 700, fontSize: 13,
                }}>
                <Icon size={16} color={active ? c.primary : c.mutedText} />
                {label}
              </button>
            )
          })}
