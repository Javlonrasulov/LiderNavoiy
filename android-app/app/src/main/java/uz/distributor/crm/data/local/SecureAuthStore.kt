...
private val Context.legacyAuthDataStore by preferencesDataStore("auth_prefs")

/**
 * Auth token/user EncryptedSharedPreferences da (AES-256).
 * Eski DataStore dan bir martalik migratsiya; parol saqlanmaydi.
 */
@Singleton
